...
struct ToolBarButtonImageBuilder {
    ...
    static func alterImageSnapper90DegreeImage() -> UIImage? {
        var rotateImageSnapperImage: UIImage? = nil
        ...
        rotateImageSnapperImage = UIGraphicsGetImageFromCurrentImageContext()
        
        UIGraphicsEndImageContext()
        
        return rotateImageSnapperImage
    }
