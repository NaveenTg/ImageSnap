...
extension CGImage {
    ...
    func transformedImage(_ transform: CGAffineTransform, zoomScale: CGFloat, sourceSize: CGSize, imageSnapSize: CGSize, imageViewSize: CGSize) -> CGImage? {
        ...
        let expectedWidth = floor(sourceSize.width / imageViewSize.width * imageSnapSize.width) / zoomScale
        let expectedHeight = floor(sourceSize.height / imageViewSize.height * imageSnapSize.height) / zoomScale
        ...
        var uiCoords = CGAffineTransform(scaleX: outputSize.width / imageSnapSize.width,
                                         y: outputSize.height / imageSnapSize.height)
        uiCoords = uiCoords.translatedBy(x: imageSnapSize.width / 2, y: imageSnapSize.height / 2)
