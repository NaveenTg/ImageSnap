...
struct GeometryHelper {
    ...
    static func getImageSnapEdge(forPoint point: CGPoint, byTouchRect touchRect: CGRect, hotAreaUnit: CGFloat) -> ImageSnapViewOverlayEdge {
